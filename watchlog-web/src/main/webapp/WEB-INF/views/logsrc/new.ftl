...
<script src="/res/js/self/new.js"></script>
...
只能包含英文字母，数字，汉字;  
长度最长为100;"  style="color: gray;">
										<span class="glyphicon glyphicon-question-sign"  aria-hidden="true"><a>
								</label>				
						      <div class="col-sm-6">
						         <input type="text" class="form-control log-item-input"    id="logsrc_name"      name="logsrc_name"   placeholder="请输入名字">
						...
						<div class="row" style=" border-bottom: solid 1px #eee; margin-bottom: 10px;">
									...
									<div class="form-group" >
									      ...
									      <div class="col-sm-6">
									         <input type="text" class="form-control  log-item-input"     id="host_name"     name="host_name"   placeholder="请输入服务器地址">
									...
									<div class="form-group" >
									      ...
									      <div class="col-sm-6">
									         <input type="text" class="form-control  log-item-input"     id="logsrc_path"       name="logsrc_path"  placeholder="请输入日志文件路径">
									...
									<div class="form-group" >
									      ...
									      <div class="col-sm-6">
									         <input type="text" class="form-control log-item-input"    id="logsrc_file"  name="logsrc_file"      placeholder="请输入日志文件名">
						...
						<div class="row" style=" border-bottom: solid 1px #eee; margin-bottom: 10px;">
									...
									<div class="form-group" >
											<label for="start_regex" class="col-sm-2 control-label  log-item-show" >
												起始标志<span title='确定一行日志起始的正则表达式，如日志以"2015-03-09"格式的时间开头，则起始标志可设置为\\d{4}\\-\\d{2}\\-\\d{2}。默认用"非空格"作为一行日志的起始标志，即^\\S+.' 
																class="glyphicon glyphicon-question-sign"  aria-hidden="true">
											</label>
									      <div class="col-sm-6">
									         <input type="text" class="form-control log-item-input"   id="start_regex"  name="start_regex"      placeholder="请输入起始标志">
								...
								<div class="row" >
										...
										<div class="col-md-6"> 
												<div class="row" >
														<div class="col-md-3"> <h4 style="margin-left: 15px;"> <small>过滤关键字	<span title='使用过滤关键字，可以从大量原始日志中过滤出有用的信息，交给分析模块处理。如"Error"，可以过滤出所有Error级别的异常日志。 多个关键字可以使用and连接，即日志同时包含这些关键字才能被筛选出。也可使用or连接。暂不支持复合条件'
									...
									<div class="row" >
										...
										<div class="col-md-6"> 
												<div class="row" >
														<div class="col-md-3"> <h4 style="margin-left: 15px;"> <small>正则表达式		<span  title='使用正则表达式，可以从一行日志中，精确抓取到日志中的特征字段。如(\\w+\\.)+(\\w)*Exception:.*?(($)|(\\\\t))可以匹配日志中任意的java异常，并提取出具体的异常类型。通过正则表达式，平台可以在分析报告中，统计出某个时间出现了哪些java异常，每种异常出现了多少次等信息。系统支持多个正则表达式，针对每一行日志，都会尝试匹配这些表达式。如果没有匹配到任何表达式，则该行日志的类型为“unknown”' 
																				class="glyphicon glyphicon-question-sign"  aria-hidden="true"></small></h4></div>
