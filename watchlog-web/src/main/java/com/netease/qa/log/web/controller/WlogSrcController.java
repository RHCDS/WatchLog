...
public class WlogSrcController {
	...
	@RequestMapping(value = "/manage/tabledata", method = RequestMethod.POST)
	public ResponseEntity<JSONObject> findLogSourceByProjectid(
		...
		if(projectid==null||limit==null||offset==null){
		...
		int recordsTotal = logSourceService.getAllLogSource(Integer.parseInt(projectid));
		String message = "select successful";
		JSONArray data = logSourceService.getLogSourceByProjectid(Integer.parseInt(projectid), Integer.parseInt(limit), Integer.parseInt(offset));
